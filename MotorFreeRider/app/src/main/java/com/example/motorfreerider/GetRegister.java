...
public class GetRegister {
    ...
    public GetRegister(String OwnerID) {
        this.OwnerID = OwnerID;
    }

    private class HttpAsyncTask_GetRegister extends AsyncTask<String, Void, String> {
        @Override
        protected String doInBackground(String... urls) {
            return POST_GetRegister(urls[0], OwnerID);
        }
    ...
    private String POST_GetRegister(String url, String string) {
    ...
    public String GetRegister() throws ExecutionException, InterruptedException {
        return new HttpAsyncTask_GetRegister().execute("http://140.121.197.213:8080/Servlet/ReceiveFile").get();
    }
}
