...
public class Cancel {
    ...
    public Cancel(user _user) {
        this._user = _user;
    }

    private class HttpAsyncTask_Cancel extends AsyncTask<String, Void, String> {
        @Override
        protected String doInBackground(String... urls) {
            return POST_Cancel(urls[0],account.getId());
        }
    ...
    private String POST_Cancel(String url, String Passenger) {
        String result = "false";
        try {
            String Owner =_user.getID();
            // 1. create HttpClient
            ...
            String string = Owner + Passenger + "Refuse";
    ...
    public String cancel() throws ExecutionException, InterruptedException {
        return new HttpAsyncTask_Cancel().execute("http://140.121.197.213:8080/Servlet/ReceiveFile").get();
    }
}